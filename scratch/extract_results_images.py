...
wb = openpyxl.load_workbook('KLA 2026 Result with Historic Data.xlsx')
ws = wb['Candidates']

os.makedirs('assets/images/results', exist_ok=True)
...
for image in ws._images:
    ...
    if not filename:
        filename = f"res_img_{cell_name}.png"
    ...
    save_path = os.path.join('assets/images/results', filename)
    img.save(save_path)
    count += 1
